...
const onlineUpiPaymentSchema = new mongoose.Schema({
    userId: {
...
onlineUpiPaymentSchema.plugin(dataTables);
module.exports = mongoose.model('online_upi_payment', onlineUpiPaymentSchema);